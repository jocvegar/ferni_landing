        ...
        <div class="flex flex-wrap -mx-4 items-center py-6 justify-between">
          <div class="px-4 py-1 space-x-1">
            ...
            >
              ...
              <span class="hidden sm:block">Dr. Ortopeda</span>
            </a>
          </div>
          <div class="flex-wrap inline-flex px-4 py-1 space-x-2 lg:space-x-4">
            ...
            >
              ...
              <div class="hidden lg:block">
                <div class="text-sm">Llamanos</div>
                <div class="font-bold text-primary-500">2225-3033</div>
              </div>
            </a>

            <a
              href="https://goo.gl/maps/wytDbY7WjAAbg3xw6"
              target="_blank"
              class="group hover:text-primary-600 inline-flex items-center leading-tight text-gray-500"
            >
              <button
            ...
            <button
              @click="handleNavBar()"
              class="border hover:bg-primary-500 hover:text-white ml-auto px-3 py-2 rounded text-primary-500 lg:hidden"
            >
      ...
      <div class="container mx-auto relative">
        <nav class="flex flex-wrap items-center px-4">
          <div
            ...
            class="flex-1 space-y-2 w-full lg:flex lg:items-center lg:space-x-4 lg:space-y-0 lg:w-auto"
            data-name="nav-menu"
          >
...
const handleNavBar = () => (showNavbar.value = !showNavbar.value);
</script>
